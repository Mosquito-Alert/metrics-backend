# Generated by Django 5.2.4 on 2025-09-18 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'engine': clickhouse_backend.models.MergeTree(order_by=['metric_id', 'h3_index', 'time'], partition_by=[clickhouse_backend.models.toYYYYMM('time')], primary_key=['metric_id', 'h3_index', 'time']),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('metric', 'h3_index'), name='spaial_dimension_unique_metric_h3_index')],
            },
        ),
        migrations.CreateModel(
