...
from metrics.regions.models import AutonomousCommunity, Municipality, Province
from metrics.regions.serializers import MunicipalityRetrieveSerializer, MunicipalitySerializer
from metrics.regions.vector_layers import (
