# Generated by Django 5.2.4 on 2025-08-21 14:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metric', models.ForeignKey(help_text='The metric associated to the regional statistics.', on_delete=django.db.models.deletion.CASCADE, related_name='regional_statistics', to='metrics.metric', verbose_name='Metric')),
            ],
            options={
                'verbose_name': 'MetricRegional Statistic',
                'verbose_name_plural': 'Metric Regional Statistics',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(help_text='The date and time of the metric values.', unique=True, verbose_name='Time')),
                ('total_cells', models.IntegerField(blank=True, default=0, help_text='The total number of cells.', verbose_name='Total Cells')),
                ('total_cells_completed', models.IntegerField(blank=True, default=0, help_text='The total number of cells processed with a prediction.', null=True, verbose_name='Total Cells Completed')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['metric', 'h3_index', 'time'], name='metrics_met_metric__ade9b5_idx')],
                'constraints': [models.UniqueConstraint(fields=('metric', 'h3_index', 'time'), name='unique_metric'), models.CheckConstraint(condition=src.utils.database_features.H3IsValidCell(models.F('h3_index')), name='h3_index_must_be_valid'), models.CheckConstraint(condition=models.Q(('value__isnull', False), ('predicted_value__isnull', False), _connector='OR'), name='value_or_predicted_value_must_be_present')],
            },
