...
from metrics.utils.datetime import generate_date_range
from metrics.utils.redis_functions import redis_lock
...
def refresh_prediction_task(metric_id, refresh_progress=True):
    ...
    """
    from metrics.predictions.models import Metric, MetricPredictionProgress, Predictor
...
def predict_batch_task(from_date, to_date, region_id=None):
    ...
    """
    from metrics.predictions.models import Metric, Predictor
...
def batch_update_metrics_for_predictor_task(predictor_id, from_date, to_date):
    ...
    """
    from metrics.predictions.models import Metric, Predictor, MetricPredictionProgress
