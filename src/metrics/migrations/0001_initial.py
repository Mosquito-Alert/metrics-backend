    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='The code of the metric, used for identification purposes. Example: bites.', max_length=32, unique=True, verbose_name='Code')),
                ('time_dimension_step', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Daily'), (2, 'Hourly')], default=1, help_text='The time dimension step for the metric.', verbose_name='Time Dimension Step')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', src.utils.database_features.RealField(help_text='The actual value of the raw data.', verbose_name='Value')),
                ...
                ('predictor', models.ForeignObject(blank=True, from_fields=['metric', 'h3_index'], help_text='The predictor associated to the predicted value.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='values', to='metrics.predictor', to_fields=['metric', 'h3_index'], verbose_name='Predictor')),
            ],
            options={
                'verbose_name': 'Value',
