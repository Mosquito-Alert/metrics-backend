    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['metric', 'time'], name='metrics_met_metric__4b8260_idx')],
                'constraints': [models.UniqueConstraint(fields=('metric', 'time'), name='unique_metric_statistics')],
            },
        ),
        migrations.CreateModel(
            name='MetricValue',
