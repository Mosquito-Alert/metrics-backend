...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Predictor',
            fields=[
                ('h3_index', src.utils.database_features.H3Field(help_text='The H3 index of the metric value boundary, used for spatial queries. This is stored as a bigInt to avoid issues with large indices, so it should be converted to/from hex strings if necessary.', verbose_name='H3 Index')),
                ('pk', models.CompositePrimaryKey('metric', 'h3_index', blank=True, editable=False, help_text='The primary key of the predictor, composed by the metric and h3 index.', primary_key=True, serialize=False, verbose_name='Primary Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(help_text='The time in which the raw value was recorded. Maximum precision is one minute.', verbose_name='Time')),
                ...
                ('predictor', models.ForeignObject(blank=True, from_fields=['metric', 'h3_index'], help_text='The predictor associated to the predicted value.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='values', to='metrics.predictor', to_fields=['metric', 'h3_index'], verbose_name='Predictor')),
            ],
            options={
                'verbose_name': 'Value',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry_days', models.PositiveIntegerField(default=30, help_text='The number of days the predictor is valid for.', verbose_name='Expiry Days')),
                ('min_days_for_training', models.PositiveIntegerField(default=30, help_text='The minimum number of days of historical data required for training the predictor.', verbose_name='Minimum Days for Training')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prediction_progress', models.FloatField(blank=True, help_text='The percentage of success of the execution.', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1)], verbose_name='Success percentage')),
                ('metric', models.ForeignKey(help_text='The metric associated to the statistics.', on_delete=django.db.models.deletion.CASCADE, related_name='statistics', to='metrics.metric', verbose_name='Metric')),
            ],
            options={
                'verbose_name': 'Metric Statistics',
                'verbose_name_plural': 'Metrics Statistics',
                'ordering': ['time'],
                'indexes': [models.Index(fields=['-time'], name='metrics_met_time_84a548_idx')],
            },
        ),
        migrations.AddIndex(
