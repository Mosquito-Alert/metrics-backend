# Generated by Django 5.2.4 on 2025-09-18 14:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'engine': clickhouse_backend.models.ReplacingMergeTree(order_by=['metric_id', 'h3_index', 'time'], partition_by=[clickhouse_backend.models.toYYYYMM('time')], primary_key=['metric_id', 'h3_index', 'time']),
                'indexes': [clickhouse_backend.models.Index(fields=['time'], granularity=4, name='time_index', type=clickhouse_backend.models.MinMax()), clickhouse_backend.models.Index(fields=['metric_id'], granularity=1, name='metric_index', type=clickhouse_backend.models.Set(1000)), clickhouse_backend.models.Index(fields=['h3_index'], granularity=4, name='h3_index_bloom_filter_index', type=clickhouse_backend.models.BloomFilter())],
